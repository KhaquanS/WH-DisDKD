...
class DisDKD(nn.Module):
    ...
    def __init__(
        ...
        print(f'Teacher regressor has {count_params(self.teacher_regressor)*1e-6:.3f}M params...')
        print(f'Student regressor has {count_params(self.student_regressor)*1e-6:.3f}M params...')
        print(f'Discriminator has {count_params(self.discriminator)*1e-6:.3f}M params...')
    ...
    def set_training_mode(self, mode):
        ...
        """
        assert mode in ['student', 'discriminator'], "Mode must be 'student' or 'discriminator'"
